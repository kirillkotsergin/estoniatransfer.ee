...
export const ui = {
  ru: {
    ...
    // 25.09.2026 на несколько часов стояло «…: цена без доплат» — владелец
    // вернул «от 130 €». Цена берётся из facts, чтобы не разойтись с тарифом.
    "meta.title": `Трансфер Таллинн — Нарва, Койдула, Лухамаа от ${facts.routes[0].price} €`,
