 ...
 *
 * Почему скриптом, а не руками: иконок шесть, они должны быть согласованы между
 * собой, и любая правка логотипа иначе означает шесть ручных экспортов. Правим
 * SVG — перезапускаем скрипт.
 *
 * Что получается и зачем каждый файл:
 *
 *   favicon.ico            16+32+48 в одном файле. Нужен даже при наличии SVG:
 *                          его просит Google для сниппета в выдаче, старые
 *                          браузеры и читалки, и его же браузер запрашивает
 *                          сам, если в <head> ничего не объявлено.
 ...
 *   icon-192.png           Android, ярлык на домашнем экране.
